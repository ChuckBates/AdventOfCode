...
namespace Day4.Specs
{
    [TestFixture]
    public class HighEntropyPassphrasesSpecs
    {
        HighEntropyPassphrases ClassUnderTest;
        [TestFixtureSetUp]
        public void Setup()
        {
            ClassUnderTest = new HighEntropyPassphrases();
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_is_null()
        {
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(null);
            Assert.AreEqual(0, validPassphrases);
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_is_empty()
        {
            List<string> passphraseList = new List<string>();
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(0, validPassphrases);
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_contains_just_whitepace()
        {
            List<string> passphraseList = new List<string> { " " };
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(0, validPassphrases);
        ...
        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_contains_one_unique_passphrase()
        {
            List<string> passphraseList = new List<string> { "a b c" };
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(1, validPassphrases);
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_contains_one_passphrase_with_duplicate_phrases()
        {
            List<string> passphraseList = new List<string> { "a b a" };
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(0, validPassphrases);
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid_and_the_list_contains_two_invalid_and_two_valid_lists()
        {
            List<string> passphraseList = new List<string> { "a b a", "b c d", "b a b", "a b c" };
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(2, validPassphrases);
        }

        [Test]
        public void when_checking_a_passphrase_contains_anagrams_and_there_is_one_anagram()
        {
            var containsAnagrams = ClassUnderTest.ContainsAnagrams("abc ced cba");
            Assert.AreEqual(true, containsAnagrams);
        }

        [Test]
        public void when_checking_a_passphrase_list_is_valid()
        {
            List<string> passphraseList = new List<string>
            {
            ...
            var validPassphrases = ClassUnderTest.GetValidPassphraseCount(passphraseList);
            Assert.AreEqual(223, validPassphrases);
        }
    }
}
