...
namespace Day7.Specs
{
    [TestFixture]
    public class RecursiveCircusSpecs
    {
        RecursiveCircus ClassUnderTest;

        [TestFixtureSetUp]
        public void Setup()
        {
            ClassUnderTest = new RecursiveCircus();
        }

        [Test]
        public void when_finding_the_bottom_program_and_the_tower_list_is_null_or_empty()
        {
            List<string> towerList = null;
            var bottomTower = ClassUnderTest.GetBottomProgram(towerList);
            Assert.AreEqual("INVALID LIST", bottomTower);
        }

        [Test]
        public void when_finding_the_bottom_program_and_the_tower_list_has_one_programs()
        {
            var towerList = "asdf (2)".Split('\n').ToList();
            var bottomTower = ClassUnderTest.GetBottomProgram(towerList);
            Assert.AreEqual("asdf", bottomTower);
        }

        [Test]
        public void when_finding_the_bottom_program_and_the_tower_list_has_three_programs()
        {
            var towerList = "asdf (2) \nzxcv (3) -> asdf, qwerty \nqwerty (5) \n".Split('\n').ToList();
            var bottomTower = ClassUnderTest.GetBottomProgram(towerList);
            Assert.AreEqual("zxcv", bottomTower);
        }

        [Test]
        public void when_finding_the_bottom_program_for_puzzle_input()
        {
            var towerList = "cfkcj (74)\n" +
                            "kmwhbm (32)\n" +
                            "uuvdgc (58)\n" +
                            "siyms (98)\n" +
                            ...
                            "vqijdaj (68)\n" +
                            "ttvyvv (26)";
            var bottomTower = ClassUnderTest.GetWeightMisbalance(towerList.Split('\n').ToList());
            Assert.AreEqual("zxcv", bottomTower);
        }

        [Test]
        public void when_parsing_a_tower_and_the_tower_has_only_a_name()
        {
            var towerPrimitive = "pbga ";
            var tower = ClassUnderTest.ParseTower(towerPrimitive);
            Assert.IsNull(tower);
        }

        [Test]
        public void when_parsing_a_tower_and_the_tower_has_a_name_and_weight()
        {
            var towerPrimitive = "pbga (66)";
            var expectedTower = new Tower
            {
                Name = "pbga",
                Weight = 66,
                UpperTowerNames = new string[] { }
            };
            var tower = ClassUnderTest.ParseTower(towerPrimitive);
            Assert.AreEqual(expectedTower, tower);
        }

        [Test]
        public void when_parsing_a_tower_and_the_tower_has_a_name_weight_and_parents()
        {
            var towerPrimitive = "fwft (72) -> ktlj, cntj, xhth";
            var expectedTower = new Tower
            {
                Name = "fwft",
                Weight = 72,
                UpperTowerNames = new[] { "ktlj", "cntj", "xhth" }
            };
            var tower = ClassUnderTest.ParseTower(towerPrimitive);
            Assert.AreEqual(expectedTower, tower);
        }
        ...
        [Test]
        public void when_sorting_a_tower_list_and_the_list_is_empty()
        {
            var towers = new List<Tower>();
            var sortedTowers = ClassUnderTest.SortTowers(towers);
            Assert.AreEqual(towers, sortedTowers);
        }

        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_one_tower()
        {
            var towers = new List<Tower> { new Tower() };
            var sortedTowers = ClassUnderTest.SortTowers(towers);
            Assert.AreEqual(towers, sortedTowers);
        }

        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_two_towers_not_related()
        {
            var towers = new List<Tower>
            {
                new Tower
        ...
        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_two_towers_where_the_first_is_the_parent()
        {
            var towers = new List<Tower>
            {
                new Tower
                {
                    Name = "tower1",
                    Weight = 0,
                    UpperTowerNames = new string[] {"tower2"}
                },
                new Tower
                {
                    Name = "tower2",
        ...
        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_two_towers_where_the_second_is_the_parent()
        {
            var towers = new List<Tower>
            {
                new Tower
                ...
                new Tower
                {
                    Name = "tower2",
                    Weight = 0,
                    UpperTowerNames = new string[] { "tower1" }
                }
            };
            var expectedTowers = new List<Tower>
            {
                new Tower
                {
                    Name = "tower2",
            ...
            var sortedTowers = ClassUnderTest.SortTowers(towers);
            Assert.AreEqual(expectedTowers, sortedTowers);
        }

        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_thre_towers_where_two_are_parents_and_the_child_is_first()
        {
            var towers = new List<Tower>
            {
                new Tower
                ...
                new Tower
                {
                    Name = "tower1",
                    Weight = 0,
                    UpperTowerNames = new string[] { "tower3"}
                },
                new Tower
                {
                    Name = "tower2",
        ...
        [Test]
        public void when_sorting_a_tower_list_and_the_list_has_thre_towers_where_two_are_parents()
        {
            var towers = new List<Tower>
            {
                new Tower
